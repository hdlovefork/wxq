...
if ($op == 'member') {
    ...
    $repair_count = pdo_fetchcolumn("SELECT COUNT(*) FROM".tablename('xcommunity_report')."WHERE weid=:weid AND type =1 AND openid=:openid AND regionid=:regionid",array(':weid' => $_W['uniacid'],':openid' => $_W['fans']['from_user'],':regionid' => $mem['regionid']));
    $report_count = pdo_fetchcolumn("SELECT COUNT(*) FROM".tablename('xcommunity_report')."WHERE weid=:weid AND type =2 AND openid=:openid AND regionid=:regionid",array(':weid' => $_W['uniacid'],':openid' => $_W['fans']['from_user'],':regionid' => $mem['regionid']));
    ...
    $homemaking_count = pdo_fetchcolumn("SELECT COUNT(*) FROM".tablename('xcommunity_homemaking')."WHERE weid=:weid AND openid=:openid AND regionid=:regionid",array(':weid' => $_W['uniacid'],':openid' => $_W['fans']['from_user'],':regionid' => $mem['regionid']));
    $houselease_count = pdo_fetchcolumn("SELECT COUNT(*) FROM".tablename('xcommunity_houselease')."WHERE weid=:weid AND openid=:openid AND regionid=:regionid",array(':weid' => $_W['uniacid'],':openid' => $_W['fans']['from_user'],':regionid' => $mem['regionid']));
    $car_count = pdo_fetchcolumn("SELECT COUNT(*) FROM".tablename('xcommunity_carpool')."WHERE weid=:weid AND openid=:openid AND regionid=:regionid",array(':weid' => $_W['uniacid'],':openid' => $_W['fans']['from_user'],':regionid' => $mem['regionid']));
    $coupon_count = pdo_fetchcolumn("SELECT COUNT(*) FROM".tablename('xcommunity_order')."WHERE weid=:weid AND from_user=:openid AND status=1 AND type = 'business'",array(':weid' => $_W['uniacid'],':openid' => $_W['fans']['from_user']));
