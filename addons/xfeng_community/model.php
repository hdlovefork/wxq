    ...
    if (empty($navs)) {
        ...
        if ($data1) {
            ...
            $menu1 = array(
                ...
                array('displayorder' => 0, 'pcate' => $nid1, 'title' => '手机开门', 'do' => 'opendoor', 'icon' => 'glyphicon glyphicon-search', 'bgcolor' => '#ec9510', 'url' => $_W['siteroot'] . 'app/index.php?i=' . $_W['uniacid'] . '&c=entry&do=opendoor&m=xfeng_community', 'status' => 1, 'uniacid' => $_W['uniacid'], 'enable' => 1, 'thumb' => $_W['siteroot'] . "addons/xfeng_community/template/static/image/icon/open.png"),
            );
...
function xqmenu(){
    ...
    if (empty($menus)) {
        ...
        $data1 = array('id' => 1,'pcate' => 0, 'title' => '基础设置', 'url' => './index.php?c=site&a=entry&do=manage&method=manage&m=xfeng_community', 'do'=> 'manage', 'method' => 'manage');
        $data2 = array('id' => 2,'pcate' => 0, 'title' => '物业服务', 'url' => './index.php?c=site&a=entry&do=fun&method=fun&m=xfeng_community', 'do'=> 'fun', 'method' => 'fun');
        $data3 = array('id' => 3,'pcate' => 0, 'title' => '小区超市', 'url' => './index.php?c=site&a=entry&do=shop&method=shop&m=xfeng_community','do'=> 'shop',  'method' => 'shop');
        $data4 = array('id' => 4,'pcate' => 0, 'title' => '小区商家', 'url' => './index.php?c=site&a=entry&do=seller&method=seller&m=xfeng_community', 'do'=> 'seller', 'method' => 'seller');
        $data5 = array('id' => 5,'pcate' => 0, 'title' => '分权系统', 'url' => './index.php?c=site&a=entry&do=perm&method=perm&m=xfeng_community', 'do'=> 'perm', 'method' => 'perm');
        $data6 = array('id' => 6,'pcate' => 0, 'title' => '云服务', 'url' => './index.php?c=site&a=entry&do=system&method=system&m=xfeng_community', 'do' => 'system', 'method' => 'system');
        if ($data1) {
        ...
        if ($data2) {
            ...
            $m2 = array(
                ...
                array('pcate' => 2, 'title' => '智能门禁', 'url' => './index.php?c=site&a=entry&op=list&do=building&m=xfeng_community','do' => 'guard', 'method' => 'fun'),
        ...
        if ($data6) {
            ...
            $m7 = array(
                ...
                array('pcate' => 6, 'title' => '系统更新', 'url' => './index.php?c=site&a=entry&op=upgrade&do=system&m=xfeng_community', 'do' => 'systemupgrade', 'method' => 'system'),
